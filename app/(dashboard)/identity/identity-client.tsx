  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <div className="relative overflow-hidden rounded-3xl border border-white/5 bg-white/5 p-8 text-center backdrop-blur-xl">
        <div className="animate-scan absolute left-0 h-0.5 w-full bg-gradient-to-r from-transparent via-slate-300 to-transparent" />
        <div className="relative z-10 flex flex-col items-center">
          <div className="mb-6 flex h-24 w-24 items-center justify-center rounded-full border-4 border-slate-400/30">
            <div className="flex h-16 w-16 items-center justify-center rounded-full bg-gradient-to-br from-slate-200 to-slate-400 shadow-[0_0_30px_rgba(148,163,184,0.5)]">
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
        ...
        <div className="rounded-3xl border border-white/5 bg-white/5 p-6 backdrop-blur-xl">
          ...
          <div className="flex flex-col gap-3">
                ...
                >
                  <div className="mb-2 flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-1.5">
                      {isLocked && (
                        <span className="flex items-center gap-1 rounded bg-emerald-500/10 px-2 py-0.5 text-[10px] font-bold uppercase text-emerald-400">
                  ...
                  <div className="flex gap-2">
                    <button
                      ...
                      className="flex flex-1 items-center justify-center gap-1.5 rounded-lg bg-slate-200 py-1.5 text-xs font-bold text-slate-900 transition hover:bg-white disabled:opacity-50"
                    >
            ...
            {adaptersLoading && (
              <p className="text-sm text-slate-500">Detecting adapters…</p>
            )}
            {!adaptersLoading && adapters.length === 0 && !adapterError && (
              <p className="text-sm text-slate-500">No adapters found.</p>
            )}
            ...
            <div className="flex items-center gap-3">
              {log.length > 0 && (
                <button
                  ...
                  className="flex items-center gap-1 text-xs text-slate-500 transition hover:text-red-400 disabled:opacity-50"
                >
            ...
            {log.map((entry, index) => (
              ...
              >
                ...
                <span className="font-mono text-slate-300">
                  ...
                  <span className="text-slate-100">{entry.new_mac}</span>
                </span>
              </div>
            ))}
          </div>
